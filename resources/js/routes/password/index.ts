...
/**
* @see \App\Http\Controllers\Auth\ResetPasswordController::resetView
* @see app/Http/Controllers/Auth/ResetPasswordController.php:25
* @route '/reset-password'
*/
export const resetView = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: resetView.url(options),
    method: 'get',
})

resetView.definition = {
    methods: ["get","head"],
    url: '/reset-password',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/reset-password'
*/
resetView.url = (options?: RouteQueryOptions) => {




    return resetView.definition.url + queryParams(options)
}
...
* @route '/reset-password'
*/
resetView.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: resetView.url(options),
    method: 'get',
})
...
* @route '/reset-password'
*/
resetView.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: resetView.url(options),
    method: 'head',
})
...
* @route '/reset-password'
*/
const resetViewForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: resetView.url(options),
    method: 'get',
})
...
* @route '/reset-password'
*/
resetViewForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: resetView.url(options),
    method: 'get',
})
...
* @route '/reset-password'
*/
resetViewForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: resetView.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
const password = {
    ...
    resetView: Object.assign(resetView, resetView),
}
